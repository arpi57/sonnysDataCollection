...
from siteAccessibility.get_satellite_images import download_satellite_images
from siteAccessibility.o4mini_images_classification import visionModelResponse

def process_data(start_index, end_index):
    excel_file_path = 'climate/unscaled_clean_dataset.xlsx'
    output_csv_path = 'siteAccessibility/output.csv'
        ...
        with open(output_csv_path, 'a', newline='', encoding='utf-8') as csvfile:
            ...
            if vision_response and 'error' not in vision_response:
                writer.writerow({
                    ...
                    'rationale': vision_response.get('rationale')
                })
                ...
                writer.writerow({
                    ...
                    'rationale': vision_response.get('error')
                })
